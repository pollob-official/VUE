...
<head>
    ...
    <body>
       ...
       @include("admin.layout.erp.partials.header")


            <!-- ========== Left Sidebar Start ========== -->
          @include("admin.layout.erp.partials.sidebar")
            <!-- ========== Left Sidebar End ========== -->
            ...
            <div class="content-page">
                ...
                <!-- Footer Start -->
                   @include("admin.layout.erp.partials.footer")
                <!-- end Footer -->
...
<!-- Mirrored from techzaa.in/velonic/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Nov 2024 06:17:25 GMT -->
</html>
